...
public class Aims {
    ...
    public static void main(String[] args) {
        ...
        cart.addDVD(availableDVDs[0], availableDVDs[1]);
        cart.addDVD(availableDVDs[2], availableDVDs[3], availableDVDs[4], availableDVDs[5]);
        ...
        DigitalVideoDisc[] dvdsToAdd = new DigitalVideoDisc[20];
        for (int i = 10; i < 30; i++) {
            dvdsToAdd[i - 10] = availableDVDs[i];
        } 
        cart.addDVD(dvdsToAdd);
        printEmptyLine();
